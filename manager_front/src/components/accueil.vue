<template>
<div class="position-absolute text-center" style="position: absolute; color: black; margin-left: 20%; margin-right:20%; margin-top: 10%;">
    <h1 class="cover-heading" style="margin: auto;"><img src="../assets/img/logo.png" height="200"></h1>
